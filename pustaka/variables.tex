\titleind{Evaluasi Performa Model \textit{Fully Convolutional Networks} (FCN) dengan Arsitektur Attention U-Net untuk Segmentasi Mikrovaskular pada \textit{Whole Slide Image} (WSI) Jaringan Ginjal Manusia} % yang ini untuk di cover
\titleindinline{Evaluasi Performa Model \textit{Fully Convolutional Networks} (FCN) dengan Arsitektur Attention U-Net untuk Segmentasi Mikrovaskular pada \textit{Whole Slide Image} (WSI) Jaringan Ginjal Manusia} % yang ini untuk di dalam paragraf
\titleen{Evaluasi Performa Model \textit{Fully Convolutional Networks} (FCN) dengan Arsitektur Attention U-Net untuk Segmentasi Mikrovaskular pada \textit{Whole Slide Image} (WSI) Jaringan Ginjal Manusia}
