\titleind{Penerapan Fully Convolutional Networks(FCN) untuk Segmentasi Mikrovaskular di Whole Slide Image (WSI) Jaringan Ginjal Manusia} % yang ini untuk di cover
