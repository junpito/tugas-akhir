\titleind{Evaluasi Performa Fully Convolutional Networks (FCN) dalam Segmentasi
	Mikrovaskular di Whole Slide Image Jaringan Ginjal Manusia Sehat} % yang ini untuk di cover
\titleindinline{Evaluasi Performa Fully Convolutional Networks (FCN) dalam Segmentasi
	Mikrovaskular di Whole Slide Image Jaringan Ginjal Manusia Sehat} % yang ini untuk di dalam paragraf
\titleen{Evaluasi Performa Fully Convolutional Networks (FCN) dalam Segmentasi
	Mikrovaskular di Whole Slide Image Jaringan Ginjal Manusia Sehat}
