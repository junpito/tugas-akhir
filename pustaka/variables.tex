\titleind{Segmentasi Otomatis Struktur Mikrovaskular pada Whole Slide Image(WSI) Jaringan Ginjal Manusia Sehat Menggunakan Fully Convolutional Networks (FCN)} % yang ini untuk di cover
\titleindinline{Segmentasi Otomatis Struktur Mikrovaskular pada Whole Slide Image(WSI) Jaringan Ginjal Manusia Sehat Menggunakan Fully Convolutional Networks (FCN)} % yang ini untuk di dalam paragraf
\titleen{Segmentasi Otomatis Struktur Mikrovaskular pada Whole Slide Image(WSI) Jaringan Ginjal Manusia Sehat Menggunakan Fully Convolutional Networks (FCN)}
