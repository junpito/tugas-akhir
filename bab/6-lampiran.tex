...
\begin{figure}[H]
	\centering
	\includegraphics[scale=.2]{gambar/lampiran/posisi-awal.png}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=.2]{gambar/lampiran/pooling.png}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=.2]{gambar/lampiran/dekonv-8.png}
\end{figure}
